...
export default function AddToPlaylistModal({ track, onClose }: AddToPlaylistModalProps) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content glass-panel-heavy add-playlist-modal" onClick={e => e.stopPropagation()}>
          ...
          {isCreating && (
            <form onSubmit={handleCreateAndAdd} className="new-playlist-form">
              ...
              <div className="form-actions">
                ...
                <button type="submit" className="btn btn-primary" disabled={!newPlaylistName.trim()}>Create</button>
              </div>
            </form>
          )}
          ...
          {playlists.map(playlist => (
            ...
            >
              ...
              <div className="playlist-list-info">
                <span className="playlist-list-name truncate">{playlist.name}</span>
                <span className="playlist-list-count">{playlist.track_count} songs</span>
              </div>
            </button>
          ))}
